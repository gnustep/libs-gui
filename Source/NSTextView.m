...
// GNU utility methods
//
/* TODO: This extension is incorrectly named. It doesn't set attributes,
it adds them. It should probably also be a programmatic change method and
not a user change method. Should rename (or even remove) and fix. */
