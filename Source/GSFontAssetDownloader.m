...
- (BOOL) validateFontFile: (NSString *)fontPath
		    error: (NSError **)error
{
  GSFontAssetInstaller *installer = [GSFontAssetInstaller sharedFontInstaller];
  return [installer validateFontPath: fontPath error: error];
}
...
{
  GSFontAssetInstaller *installer = [GSFontAssetInstaller sharedFontInstaller];
  return [installer installFontPath: fontPath error: error];
}
