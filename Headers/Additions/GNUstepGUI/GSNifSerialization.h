 ...
 * NIF property names and whose values are KVC keys on the object. An explicit
 ...
 * arrays of inferred NIF keys that must not be persisted. Exclusions are
 ...
 * array is used as both the NIF property name and the KVC key.
 */
+ (NSData *) dataWithTopLevelObjects: (NSArray *)topLevelObjects
