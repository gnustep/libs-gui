/** <title>AppKitExceptions</title>

    <abstract>Exception name constants for AppKit framework</abstract>

    This header defines the standard exception names used throughout the
    AppKit framework. These exceptions are raised by various AppKit classes
    and methods to indicate error conditions specific to user interface
    operations, document handling, printing, and other AppKit functionality.

    The exception names defined here provide a standardized way to handle
    and identify specific types of errors that can occur during AppKit
    operations. Applications can catch these exceptions to provide
    appropriate error handling and user feedback.

    Common exception categories include:
    * Window and view hierarchy exceptions
    * Document loading and saving exceptions
    * Printing and page layout exceptions
    * Image and graphics context exceptions
    * User interface validation exceptions
