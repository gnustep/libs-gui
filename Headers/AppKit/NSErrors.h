/** <title>NSErrors</title>

    <abstract>Error domain and code constants for AppKit NSError objects</abstract>

    This header defines error domain constants and error codes that are used
    with NSError objects throughout the AppKit framework. These standardized
    error identifiers provide consistent error reporting for AppKit operations
    such as document handling, printing, image processing, and user interface
    operations.

    The error domains and codes defined here allow applications to:
    * Identify specific types of AppKit-related errors
    * Provide appropriate error handling logic
    * Display meaningful error messages to users
    * Implement proper error recovery strategies

    Error domains include areas such as document operations, printing system
    errors, graphics context errors, and user interface validation failures.
