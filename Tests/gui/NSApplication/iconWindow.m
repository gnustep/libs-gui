/* The application icon window is created only when the GSEnableAppIcon
   ...
   test forces the default off and iconWindowEnabled.m forces it on.  The
...
main(int argc, char **argv)
{
  ...
  PASS([NSApp iconWindow] == nil,
    "no icon window is created when GSEnableAppIcon is NO")

  END_SET("NSApplication icon window off by default")
